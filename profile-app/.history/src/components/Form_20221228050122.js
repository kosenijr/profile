            ...
            <div className="contact-form">
                <form>
                    <ul>
                        ...
                        <br />
                        The best way to reply to contact me  be <div className="contact-form-input" contenteditable="true" data-target="contact-mail-input" onClick={() => handleInputs()}>this  </div>.
                        <br />
