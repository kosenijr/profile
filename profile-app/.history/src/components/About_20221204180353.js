    ...
    return (
        <div className='main-container' id='background'>
            <div className='desc-sub-container'>
                ...
                <p>As for my programming projects, those are located in the portfolio section. It is very humbling and I am learning a lot from I pray that you'll join me on my journey of programming.</p>
            </div>
