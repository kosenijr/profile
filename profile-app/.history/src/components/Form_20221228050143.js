            ...
            <div className="contact-form">
                <form>
                    <ul>
                        ...
                        <br />
                        The best email address to contact me is  be <div className="contact-form-input" contenteditable="true" data-target="contact-mail-input" onClick={() => handleInputs()}>this  </div>.
                        <br />
