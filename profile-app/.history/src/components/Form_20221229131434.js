            ...
            <div className="contact-form">
                <form>
                    <ul>
                        ...
                        <br />
                        My best contact is <div className="contact-input" contenteditable="true" data-target="contact-mail-input" onClick={() => handleInput()}><input type="text" className="contact-mail-input" placeholder='this email' /></div>.
                        <br />
