            ...
            <div className="contact-form">
                <form>
                    <ul>
                        ...
                        Hello,
                        <br />
                        I am <div className="contact-form-input" contenteditable="true" data-target="contact-name-input" > <input type="text" className="contact-name-input" placeholder='this name' /></div>.
                        <br />
