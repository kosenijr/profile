            ...
            <div className="contact-form">
                <form>
                    <ul>
                        ...
                        <br />
                        My best contact is <div className="input-wrapper"> <input type="text" className="contact-mail-input" defaultValue={() => handleInput()} placeholder='this email' /></div>
                        <br />
                        I'd like to leave <div className="input-wrapper"> <input type="text" className="contact-message-input" defaultValue={() => handleInput()} placeholder='this message' /></div>
                    </ul>
                </form>
            </div>
