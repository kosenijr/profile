            ...
            <div className="contact-form">
                <form>
                    <ul>
                        ...
                        <br />
                        My best contact is <div className="input-wrapper" contenteditable="true" data-target="contact-mail-input"><input type="text" className="contact-mail-input" placeholder='this email' /></div>.
                        <br />
