            ...
            <div className="contact-form">
                <form>
                    <ul>
                        ...
                        <br />
                        My best contact is <div className="input-wrapper"> <input type="text" onChange={handleContactChange} className="contact-mail-input"  value={contact} placeholder='this email' /></div>
                        <br />
