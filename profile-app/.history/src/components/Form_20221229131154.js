            ...
            <div className="contact-form">
                <form>
                    <ul>
                        ...
                        <br />
                        I'd like to leave <div className="contact-form-input" contenteditable="true" data-target="contact-message-input" onClick={() => handleInput()}> <input type="text" className="contact-message-input" placeholder='this message' /></ldiv>.
                    </ul>
                </form>
            </div>
