    ...
    return (
        <div className='main-container' id='about-background'>
            <div className='desc-sub-container' id='my-summary'>
                ...
                <br />
                <p>As for my t projects, those are located in the portfolio section. It is very humbling and I am learning a lot. I pray that you'll join me on my journey of programming.</p>
                <br />
