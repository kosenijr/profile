            ...
            <div className="contact-form">
                <form>
                    <ul>
                        ...
                        <input type="text" className="contact-mail-input" placeholder='this email' />
                        <input type="text" className="contact-message-input" placeholder='this message' />

                        Hello,
                        <br />
                        I am <div className="contact-form-input" contenteditable="true" data-target="contact-name-input" placeholder=placeholder onClick={() => handleInput()}></div>.
                        <br />
                        ...
                        <br />
                        I'd like to leave <div className="contact-form-input" contenteditable="true" data-target="contact-message-input" onClick={() => handleInput()}>this message
                        </div>.
                    </ul>
                </form>
            </div>
