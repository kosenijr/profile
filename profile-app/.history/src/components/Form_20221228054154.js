            ...
            <div className="contact-form">
                <form>
                    <ul>
                        ...
                        <input type="text" className="contact-name-input" placeholder='' />
                        <input type="text" className="contact-mail-input" />
                        <input type="text" className="contact-message-input" />

                        Hello,
                        <br />
                        I am <div className="contact-form-input" contenteditable="true" data-target="contact-name-input" onClick={() => handleInput()}>this name</div>.
                        <br />
