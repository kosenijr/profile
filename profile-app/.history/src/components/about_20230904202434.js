    ...
    <div className="main-container" id="about-background">
      <div className="desc-sub-container" id="my-summary">
        ...
        <p>
          ...
          and a camera in hand? Well, life has its surprises! In my mid-20s,
          while working at the David Rockefeller Fund, I discovered a nearby
        ...
        <p>
          ...
          website and the projects within are my way of sharing the beauty of
          code and visuals with those who appreciate it. Thank you for visiting!
        </p>
