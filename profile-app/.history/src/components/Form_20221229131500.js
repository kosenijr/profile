            ...
            <div className="contact-form">
                <form>
                    <ul>
                        ...
                        <br />
                        My best contact is <div className="input-wrapper" contenteditable="true" data-target="contact-mail-input" onClick={() => handleInput()}><input type="text" className="contact-mail-input" placeholder='this email' /></div>.
                        <br />
                        I'd like to leave <div className="input-wrapper" contenteditable="true" data-target="contact-message-input" onClick={() => handleInput()}> <input type="text" className="contact-message-input" placeholder='this message' /></div>.
                    </ul>
                </form>
            </div>
