            ...
            <div className="contact-form">
                <form>
                    <ul>
                        ...
                        <br />
                        My best contact is <div className="input-wrapper"> <input type="text" className="contact-mail-input" onChange={() => handleContactChange()} placeholder='this email' /></div>
                        <br />
                        I'd like to leave <div className="input-wrapper"> <input type="text" className="contact-message-input" onChange={() => handleMessageChange()} placeholder='this message' /></div>
                        <br />
                        <button onlick={() => handleSubmitClick}>Submit</button>
                    </ul>
                </form>
            </div>
