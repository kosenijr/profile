            ...
            <div className="contact-form">
                <form>
                    <ul>
                        ...
                        <br />
                        My best contact is <div className="input-wrapper"> <input placeholder='this email' value={contact} type="text" onChange={handleContactChange} className="contact-mail-input"    /></div>
                        <br />
