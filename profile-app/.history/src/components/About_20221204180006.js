    ...
    return (
        <div className='main-container' id='background'>
            <div className='desc-sub-container'>
                ...
                <p>My first name is pronounced Ky-yoh-day. It means that I bring joy and honestly, that is what I plan to do with this site. The four pages that make this site consist of my personal pictures that have never</p>
            </div>
