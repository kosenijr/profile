    ...
    return (
        <div className='main-container' id='about-background'>
            <div className='desc-sub-container' id='my-summary'>
                ...
                <p>My first name is pronounced kai
·yoh-day. It means that I bring joy and that is exactly what I plan to do here! This site's four pages consist of personal pictures taken by my wife and me. I hope you enjoy our creativity!</p>
                <br />
