    ...
    return (
        <div className='main-container' id='background'>
            <div className='desc-sub-container'>
                ...
                <p>My first name is pronounced Ky-yoh-day. It means that I bring joy and honestly, that is what I plan to do with this site. The four pages that make this site consist of personal pictures belonging to my wife and me. I look</p>
            </div>
