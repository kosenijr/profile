            ...
            <div className="contact-form">
                <form>
                    <ul>
                        ...
                        <br />
                        My best contact is <div className="input-wrapper"> <input type="text" className="contact-mail-input" onClick={() => setContact('')} onChange={handleContactChange} value={contact} placeholder='this ' /></div>
                        <br />
