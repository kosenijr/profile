            ...
            <div className="contact-form">
                <form>
                    <ul>
                        ...
                        <br />
                        My best emailaddress contact me is  be <div className="contact-form-input" contenteditable="true" data-target="contact-mail-input" onClick={() => handleInputs()}>this  </div>.
                        <br />
