    ...
    return (
        <form>
            <ul>
                ...
                My name is <div className="contact-form-input" contenteditable="true" data-></div>.
                <br />
                The best email for your reply is <div className="contact-form-input" contenteditable="true" data-></div>.
                <br />
                I'd like to say that <div className="contact-form-input" contenteditable="true" data-></div>.
