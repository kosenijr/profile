            ...
            <div className="contact-form">
                <form>
                    <ul>
                        ...
                        <br />
                        My best contact is <div className="input-wrapper"> <input value={contact}type="text" onChange={handleContactChange} className="contact-mail-input"   placeholder='this email' /></div>
                        <br />
