            ...
            <div className="contact-form">
                <form>
                    <ul>
                        ...
                        Hello,
                        <br />
                        I am <div className="input-wrapper" data-target="contact-name-input" > <input type="text" className="contact-name-input" placeholder='this name' onClick={() => handleInput()} /></div>.
                        <br />
                        My best contact is <div className="input-wrapper" data-target="contact-mail-input"><input type="text" className="contact-mail-input" onClick={() => handleInput()} placeholder='this email' /></div>.
                        <br />
                        I'd like to leave <div className="input-wrapper" data-target="contact-message-input"> <input type="text" className="contact-message-input" onClick={() => handleInput()} placeholder='this message' /></div>.
                    </ul>
                </form>
            </div>
