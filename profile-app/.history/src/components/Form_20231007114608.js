...
const [nameRegex, contactRegex, messageRegex] = [/^[A-Za-z(\s)A-Za-z'-]+$/, 0, 0];
log(
  nameRegex.test("Kayode Oseni"),
  nameRegex.test("Pura Perez-Oseni"),
  nameRegex.test("Zuri O'Connor"),
  nameRegex.test("Tunde Olabisi Ret"),
  nameRegex.test(""),
  nameRegex.test(" "),
  nameRegex.test("   "),
  nameRegex.test(" Tunde"),
  );
