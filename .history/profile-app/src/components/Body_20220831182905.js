    ...
    return (
        <div id="body-main">
            <div className="short-statement">
                <p className='front-text' id='text-1'>Hi, my name is Kayode Oseni. I am a front-end developer and photographer. Plus, I have a few things I'd like to show you.</p>
                <br />
