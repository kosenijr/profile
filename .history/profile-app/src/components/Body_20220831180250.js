    ...
    return (
        <div id="body-main">
            <div className="short-statement">
                <p id='front-text-1'>Hi, my name is Kayode Oseni. I am a front-end developer and lover of photography. I have a few things I'd like to show you.</p>
                <br />
                <p id='front-text-2'>C'mon!</p>
            </div>
            <div id='container'>
